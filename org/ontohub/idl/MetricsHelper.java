...
/**
* org/ontohub/idl/MetricsHelper.java .
...
{
  private static String  _id = "IDL:org/ontohub/idl/Metrics:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (org.ontohub.idl.MetricsHelper.id (), "Metrics", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    org.ontohub.idl.Metrics value = new org.ontohub.idl.Metrics ();
